...
export function REPLInput(props: REPLInputProps) {
  ...
  const handleLoad: REPLFunction = async (args: string[]): Promise<string> => {
    ...
    try {
      const response = await fetch(
        `https://cs32customserver.com/repl/loadcsv?filepath=${filepath}`
      );
      if (response.ok) {
  ...
  const handleView: REPLFunction = async (args: string[]): Promise<string> => {
    ...
    try {
      const response = await fetch("https://cs32customserver.com/repl/viewcsv");
      if (response.ok) {
        const data = await response.json();
        const resultMessage =
  ...
  const handleSearch: REPLFunction = async (
    ...
    try {
      const response = await fetch(
        `https://cs32customserver.com/repl/searchcsv?headers=${hasHeaders}&value=${value}&colid=${columnId}`
      );
      if (response.ok) {
        const data = await response.json();
        const resultMessage =
  ...
  const handleBroadband: REPLFunction = async (
    ...
    try {
      const response = await fetch(
        `https://cs32customserver.com/repl/broadband?state=${state}&county=${county}`
      );
      if (response.ok) {
        const data = await response.json();
        const resultMessage =
